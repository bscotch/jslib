...
- **Chinese & Japanese**: Breaking on ideographs while ensuring that punctuation is attached to the appropriate adjacent character, and treating non-CJ text as distinct ideographs.

## Usage

```typescript
import { splitOnIdeograph } from '@bscotch/l10n-breaks';
